from turn_django import mixins
...
class Multi_serializer_viewset( viewsets.GenericViewSet ):
    ...
    def get_serializer( self, *args, serializer_name='default',  **kargs ):
        serializer_class = self.get_serializer_class( serializer_name )
        kargs['context'] = self.get_serializer_context()
        return serializer_class(*args, **kargs)
    ...
    def get_serializer_class( self, serializer_name='default' ):
        ...
        try:
            ...
            try:
                ...
                raise KeyError( _( 'The serializer %s is not defined'
                                    ) % serializer_name )
